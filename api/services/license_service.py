...
class LicenseService:
    ...
    def get_enabled_features(self) -> List[str]:
        ...
        # If personal use, all features are enabled
        ...
        # If licensed, return licensed features
        if installation.license_status == "active" and installation.licensed_features:
            ...
            if installation.validation_cache_expires_at:
                ...
                if now < cache_expires and installation.last_validation_result:
                    # Cache is valid
                    return installation.licensed_features
            
            # Cache expired, re-verify license
