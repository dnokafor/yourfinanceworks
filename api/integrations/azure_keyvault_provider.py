...
class AzureKeyVaultProvider:
    ...
    def __init__(self, config: EncryptionConfig):
        """Initialize Azure Key Vault provider with configuration."""
        self.config = config
        ...
        try:
            ...
            logger.info(f"Azure Key Vault clients initialized for vault: {self.vault_url}")
    ...
    def health_check(self) -> Dict[str, Any]:
        """
        Perform a health check on the Azure Key Vault connection.
